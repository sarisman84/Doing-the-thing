    ...
    public class DoorControllerEditor : UnityEditor.Editor
    {
        ...
        private void OnSceneGUI()
        {
            ...
            Handles.ConeHandleCap(0, position,
                Quaternion.LookRotation((_selfRef.DoorOpenPosition - position).normalized), 0.25f, EventType.Repaint);

            Handles.color = Color.white;
            Handles.DrawLine(position, _selfRef.DoorOpenPosition);

            Handles.color = Color.red;
            Handles.CubeHandleCap(0, _selfRef.DoorOpenPosition,
            ...
            _selfRef.doorOpenPosition =
                Handles.PositionHandle(_selfRef.DoorOpenPosition, Quaternion.identity) - position;


            Handles.color = Color.red - new Color(0, 0, 0, 0.7f);
            Handles.DrawWireCube(_selfRef.DoorOpenPosition,
